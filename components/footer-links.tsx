  ...
  return (
    <div className="px-4 py-8 bg-gray-50/50 mt-8 text-sm">
      <div className="flex flex-wrap gap-x-4 gap-y-3 mb-6 font-medium">
        ...
        <Link href="#" className="hover:underline">Форум Авто Журнал</Link>
      ...
      <p className="text-muted-foreground text-xs leading-relaxed mb-6">
        Форум Авто — <Link href="#" className="underline">сайт объявлений России</Link>. © ООО «КЕХ еКоммерц» 2007–2026. <Link href="#" className="underline">Правила Форума Авто</Link>. <Link href="#" className="underline">Политика конфиденциальности</Link>. Оплачивая услуги на Форум Авто, вы принимаете <Link href="#" className="underline">оферту</Link>. Форум Авто использует <Link href="#" className="underline">рекомендательные технологии</Link>.
      </p>
