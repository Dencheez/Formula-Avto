...
import { Bell, Settings, MessageSquare, Heart, Phone } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-background max-w-lg mx-auto flex flex-col pb-20">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 pt-10 pb-6 text-center">
        ...
        <button className="w-full max-w-[320px] bg-[#E5F5FF] text-[#00AAFF] py-3.5 rounded-xl font-medium text-[16px] hover:bg-blue-100 transition-colors">
