...
export default function ListingsPage() {
  ...
  return (
    <div className="min-h-screen bg-background max-w-lg mx-auto flex flex-col pb-20">
      {/* Header */}
      <header className="px-4 py-4 flex items-center justify-center relative border-b border-border/40">
        <h1 className="text-lg font-bold">Мои объявления</h1>
      </header>

      {/* Content */}
      <div className="flex-1 flex flex-col items-center justify-center px-4 pt-10 pb-6">
